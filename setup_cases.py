...
var_1 = CaseVariableData("fleet_size",os.path.join("config","TNCFleetModel_joint_proactive_repo.json"),["Operator_1", "Fleet_Base", "TNC_FLEET_SIZE"],fleet_sizes)
var_2 = CaseVariableData("rl_discount_rate",os.path.join("config","TNCFleetModel_joint_proactive_repo.json"),["DRS_Discount_AR","scaling_future_revenue"],discount_rates)
